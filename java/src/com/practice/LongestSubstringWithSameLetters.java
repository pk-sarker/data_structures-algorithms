...
public class LongestSubstringWithSameLetters {
    ...
    public static void main(String args[]) {
        System.out.println(LongestSubstringWithSameLetters.findLength("aabccbb", 2));
        System.out.println(LongestSubstringWithSameLetters.findLength("abbcb", 1));
        System.out.println(LongestSubstringWithSameLetters.findLength("abccde", 1));
    }
}
